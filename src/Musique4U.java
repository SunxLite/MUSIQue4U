                  ...
                  if (choice == 1) { // add media
                     ...
                     // Checking secondary specs
                        if (choice == 1) { // Music object
                           ...
                           Media newMusic = new Music(Media.maxID + 1, title, genre, secondarySpecs[0], secondarySpecs[1]);
                        ...
                        // add newMusic into selected playlist for the current user
                           ...
                           try {
                              Media newVideo = new Video(Media.maxID + 1, title, genre,
                     ...
                     // Checking secondary specs
                        if (choice == 1) { // Music object
                           ...
                           System.out.println("Attempting to remove the media.");
                           ...
                           try {
                              selected.removeMedia(new Video(-1, title, genre, Double.parseDouble(secondarySpecs[0].trim()),
       ...
       private void searchInterface() {
         ...
         // Secondary data
            ...
            if (!type.equalsIgnoreCase("Music") && !type.equalsIgnoreCase("Video")) {
               System.out.println("Invalid, Search defaulted to all media");
               type = null;
            }
